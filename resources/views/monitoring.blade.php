    ...
    <a href="{{ url('/analisis') }}" class="flex items-center gap-3 px-4 py-3 {{ Request::is('analisis') ? 'bg-blue-50 text-blue-600' : 'text-gray-500' }} rounded-xl font-medium transition">
        ...
        <main class="flex-1 overflow-y-auto p-8">
            <header class="flex justify-between items-center mb-8">
                ...
                <a href="{{ route('monitoring.export') }}" class="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition shadow-sm">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4 font-medium text-gray-800">{{ $reading->voltage }} V</td>
                            <td class="p-4 font-medium text-gray-800">{{ $reading->current }} A</td>
                            <td class="p-4 font-medium text-gray-800">{{ $reading->power }} W</td>
                            <td class="p-4 font-medium text-gray-800">{{ $reading->energy }} kWh</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
