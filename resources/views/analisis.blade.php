...
<body class="bg-gray-50 flex h-screen overflow-hidden">
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
        ...
        <nav class="flex-1 px-4 space-y-2 mt-4">
            ...
            <a href="{{ url('/pembersih') }}" class="flex items-center gap-3 px-4 py-3 text-gray-500 hover:bg-gray-100 rounded-xl font-medium transition">
                <i class="ph ph-drop text-xl"></i> Sistem Pembersih
            </a>
            <a href="{{ url('/analisis') }}" class="flex items-center gap-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-xl font-medium transition">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center">
                ...
                <div class="relative w-full h-64">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center flex-col">
                        <span class="text-3xl font-bold text-indigo-600">{{ number_format($efficiency, 1) }}%</span>
            ...
            <div class="lg:col-span-2 bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-6">
                    <div class="flex justify-between items-end border-b pb-4">
                        ...
                        <span class="font-bold text-xl">{{ $maxPower }} W</span>
                    </div>
                    <div class="flex justify-between items-end border-b pb-4">
                        <span class="text-gray-500 text-indigo-600">Daya Terukur Saat Ini</span>
                        <span class="font-bold text-xl text-indigo-600">{{ $currentPower }} W</span>
                    </div>
                    <div class="flex justify-between items-end border-b pb-4 text-red-500">
                        ...
                        <span class="font-bold text-xl">-{{ number_format($maxPower - $currentPower, 2) }} W</span>
                    </div>
                </div>
            </div>
        </div>
