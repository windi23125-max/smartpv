            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="flex items-baseline gap-1 mt-1">
                        <span class="text-3xl font-bold text-gray-800">{{ $latest->voltage ?? 0 }}</span>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="flex items-baseline gap-1 mt-1">
                        <span class="text-3xl font-bold text-gray-800">{{ $latest->current ?? 0 }}</span>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="flex items-baseline gap-1 mt-1">
                        <span class="text-3xl font-bold text-gray-800">{{ $latest->power ?? 0 }}</span>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="flex items-baseline gap-1 mt-1">
                        <span class="text-3xl font-bold text-gray-800">{{ $latest->energy ?? 0 }}</span>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr>
                                    <td class="py-3 text-gray-600">{{ $item->created_at->format('H:i:s') }}</td>
                                    <td class="py-3 font-semibold text-gray-800">{{ $item->power }} W</td>
                                </tr>
                                @empty
