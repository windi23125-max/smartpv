                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-48 relative overflow-hidden group">
                    ...
                    <div>
                        <div class="p-3 w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors
                            <?php echo e($device->status ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500'); ?>" 
                            id="icon-<?php echo e($device->id); ?>">
                            <i class="ph <?php echo e($device->name == 'Pompa Pembersih' ? 'ph-drop' : 'ph-gear'); ?> text-2xl"></i>
                        </div>
                        <h3 class="text-lg font-bold text-gray-800"><?php echo e($device->name); ?></h3>
                        <p class="text-sm text-gray-400" id="status-text-<?php echo e($device->id); ?>">
                            <?php echo e($device->status ? 'Sedang Aktif' : 'Non-Aktif'); ?>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" 
                                onchange="toggleDevice(<?php echo e($device->id); ?>)" 
                                <?php echo e($device->status ? 'checked' : ''); ?>>
...
</html><?php /**PATH D:\laragon\www\smartpv\resources\views/kontrol.blade.php ENDPATH**/ ?>